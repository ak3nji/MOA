 ...
 * @version $Revision$
 */
public class CorrelationAttributeSetEval extends AttributeSetEvaluator implements AttributeEvaluator, OptionHandler {
     ...
     * 
     * @param d true if detailed (per-value) correlation is to be output for nominal
     *          attributes
     */
     ...
     * 
     * @return true if detailed (per-value) correlation is to be output for nominal
     *         attributes
     */
    ...
    /**
     * Initializes an information gain attribute evaluator. Replaces missing values
     * with means/modes; Deletes instances with missing class values.
     * 
    ...
    public static void main(String[] args) {
        runEvaluator(new CorrelationAttributeSetEval(), args);
    }

    /**
     * calculate correlation between sets of attributes
     *
