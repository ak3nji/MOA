 ...
 * @version $Revision: 7 $
 */
public class DDWOnlineSubspaceEnsemble extends AbstractClassifier implements MultiClassClassifier {
    ...
    protected List<Double> instancesSeen;
    ...
    public void trainOnInstanceImpl(Instance instance) {
        ...
        if(this.isChunkReady) {
            ...
            if(newAttr.length != 1) {
            	...
            	System.out.println("failed to find relevant features");
            ...
            if(newAttr.length != 1)
            	...
            	//System.out.println("Null attribute selection");
            }
            // Training classifier
            for (int i = 0; i < this.buffer.numInstances() - 1; i++) {
    ...
    public double[] getVotesForInstance(Instance instance) {
        ...
        for (int i = 0; i < this.ensemble.size(); i++) {
            ...
            if (vote.sumOfValues() > 0.0) {
                vote.normalize();
                weight = this.instancesCorrectlyClassified.get(i) / this.instancesSeen.get(i);
                vote.scaleValues(weight);
    ...
    private void buildEnsemble(Instance instance) {
        ...
        this.instancesSeen = new ArrayList<Double>();
        this.instancesCorrectlyClassified = new ArrayList<Double>();
    ...
    protected void removeEnsembleMemser(int i) {
        ...
        this.instancesSeen.remove(i);
        this.instancesCorrectlyClassified.remove(i);
    }
