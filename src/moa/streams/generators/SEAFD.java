 ...
 */
public class SEAFD extends AbstractOptionHandler implements InstanceStream {
    ...
    public IntOption numRandomAttsOption = new IntOption("numRandomAtts", 'R', "", 0, 0, 1024);

    public IntOption numRedundantFeaturesOption = new IntOption("numRedundantFeatures", '-', "# of redundant features",
            0, 0, 1000);

    public IntOption numCosineNonLinearRedundantFeaturesOption = new IntOption("numCosineNonLinearRedundantFeatures",
            '_', "# of cosine non linear redundant features", 0, 0, 1000);

    public IntOption numRBFlikeNonLinearRedundantFeaturesOption = new IntOption("numRBFLikeNonLinearRedundantFeatures",
    ...
    protected void prepareForUseImpl(TaskMonitor monitor, ObjectRepository repository) {
        ...
        this.nonLinearCosineRedundantTo = new HashMap<>();
        this.nonLinearRBFLikeRedundantTo = new HashMap<>();
    ...
    public void restart() {
        ...
        for (int i = 0; i < streamHeader.numAttributes() - 1; i++) {
            ...
            if (this.indicesRelevants.contains(i) && !this.redundantTo.keySet().contains(att)) {
